define(["avalon","utils"], function (avalon, utils) {
    ...
    avalon.ui["grid"] = function (element, data, vmodels) {
        ...
        var h = utils.getFrameInfo().contentHeight - jQuery(jQuery(element).parent().children(".container-fluid")).height()-70;
        ...
        jQuery(element).children("table").jqGrid({
            ...
            width: utils.getFrameInfo().contentWidth-20,
            height: h,
            rowNum: 15,
            rowList:[15,30,45],
            multiselect: true,
